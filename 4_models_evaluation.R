...
###Load all the results for the simplified lasso logistic regression###

load("modifiedSP_cal_lasso_regular_baggedtree_scale2_6p.Rda", verbose = T) #This will give calibration_measure_imp data frame.
load("modifiedSP_cstat_lasso_regular_baggedtree_scale2_6p.Rda", verbose = T) #This will give c_stat_imp data frame.
load("modifiedSP_simpen_lasso_regular_baggedtree_scale2_6p.Rda", verbose = T) #This will give simpen data frame.
...
ggplot(simpen, aes(x = .pred_1)) +
  ...
  theme_minimal() +
  labs(title = "Lasso logistic regression")
